...
if(isset($_POST['update_profile'])) {
    ...
    if(!empty($_POST['password'])) {
        ...
        $sql = "UPDATE doctor SET name='$name', email='$email', phone_number='$phone', password='$password' WHERE doctor_id='$doc_id'";
    } else {
        $sql = "UPDATE doctor SET name='$name', email='$email', phone_number='$phone' WHERE doctor_id='$doc_id'";
    }
        ...
        <div class="col-md-8">
            <div class="card shadow border-0 rounded-4">
                <div class="card-header bg-white border-0 pt-4 px-4">
                    <h5 class="fw-bold text-dark"><i class="fas fa-user-md me-2"></i>My Profile</h5>
                </div>
